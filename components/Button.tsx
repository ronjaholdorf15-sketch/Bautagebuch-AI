...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "border-transparent text-white bg-brand-primary hover:bg-brand-primary/90 focus:ring-brand-primary/50",
    secondary: "border-transparent text-brand-primary bg-brand-primary/10 hover:bg-brand-primary/20 focus:ring-brand-primary/50",
